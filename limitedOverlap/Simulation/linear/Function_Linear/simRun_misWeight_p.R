...
###homogenous treatment effects for linear outcome

###rerun pencomp 6/26/2020
...
#DIRECR="C:/Users/Tingting.Zhou/Desktop/paper2/revision/linear2/homoT/"  ###simulation result

DIRECR="C:/Users/tkzhou/Desktop/linear/homoT/"
DIRECF="C:/Users/tkzhou/Desktop/linear/Function_Linear/"
  ...
  tryCatch ( 
    {
        ...
        tryCatch ( 
          {
            ...
            tempR=pencomp(dataOR, data, propenVarList, outcomeVarList0=outcomeVarList0[-c(4)], outcomeVarList1=outcomeVarList1[-c(4)], treat.varname, outcome.varname, truncateQVal, truncateVal)
      ...
      write.table(ATT_pencomp, paste(DIRECR, "sampleSize", sampleSize, "/gamma", gammaV, "/ATT_pencomp", "_", modelSpec, ".txt", sep=""), 
                  col.names=c("estimate", "std", "lowerCI", "upperCI"),  row.names = F, quote = F)

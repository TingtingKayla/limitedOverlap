...
methods2 = c("pencomp", "pencomp ATM",  "pencomp ATO" , "pencomp ATT",        
"pencomp ATC" ,  "truncate pencomp0.01", "truncate pencomp0.05", "truncateQ pencomp0" ,
...
misPredResult=rbind(misPred["ATE",], misPred["ATE aug",], misPred["pencomp",], misPred2["pencomp",],
                    ...
                    misPred["ATM",], misPred["ATM aug",], misPred["pencomp ATM",], misPred2["pencomp ATM",], 
                    
                    misPred["ATO",], misPred["ATO aug",], misPred["pencomp ATO",], misPred2["pencomp ATO",],
                    
                    misPred["ATT",], misPred["ATT aug",], misPred["pencomp ATT",], misPred2["pencomp ATT",], 
                    
                    misPred["ATC",], misPred["ATC aug",], misPred["pencomp ATC",], misPred2["pencomp ATC",], 
...
pdf(paste0(DIREC_ROOT, "Results/linear.pdf"))

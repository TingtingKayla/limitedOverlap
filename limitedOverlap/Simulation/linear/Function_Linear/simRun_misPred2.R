...
###start with 538 for misPred2
###start with 440 for misPred
###start with 368 for both
...
#DIRECR="C:/Users/Tingting.Zhou/Desktop/paper2/revision/linear3/homoT/"  ###simulation result

...
###variance of proportion difference###
varPropDiff2=function(imputed1, imputed0, weight){
  
  p1=mean(imputed1)
  p2=mean(imputed0)
  varOut=sum(weight^2 * p1*(1-p1))/(sum(weight))^2 + sum(weight^2 * p2 * (1-p2))/(sum(weight))^2
  return(varOut)
  
}


###variance of proportion difference based on McNemar test###
varPropDiff=function(imputed1, imputed0, weight){
  
  index10 = which(imputed1==1 & imputed0==0)
  index01 = which(imputed1==0 & imputed0==1)
  
  sumIndex10=sum(weight[index10])
  sumIndex01=sum(weight[index01])
  
  mtable=c(sumIndex10, sumIndex01)/sum(weight)
  varOut=(mtable[1] + mtable[2] - (mtable[1] - mtable[2])^2)/sum(weight)
...
###############################################
varPropDiff3=function(imputed1, imputed0, weight){
  ...
  mtable=c(sumIndex10, sumIndex01)
  varOut=(mtable[1] + mtable[2])/(sum(weight)^2)
...
pencomp = function(dataOR, data, propenVarList, outcomeVarList0, outcomeVarList1, treat.varname, outcome.varname, truncateQVal, truncateVal, num.knot=20) {
  tryCatch ( 
    {
      ...
      imputed0_fit = imputeF(dataFit=data0, newdata=newData0, outcome.varname=outcome.varname, outcomeVarList=outcomeVarList0, num.knot)
      pspp0=imputed0_fit$modelOut
      imputed0=imputed0_fit$imputed
      imputed0_prob=imputed0_fit$imputed_prob
      ...
      imputed1_fit = imputeF(dataFit=data1, newdata=newData1, outcome.varname=outcome.varname, outcomeVarList=outcomeVarList1, num.knot)
      pspp1=imputed1_fit$modelOut
      imputed1=imputed1_fit$imputed
      imputed1_prob=imputed1_fit$imputed_prob
      ...
      #######include everyone
      ATE=c(mean(imputed1-imputed0), varPropDiff(imputed1=imputed1, imputed0=imputed0, weight=rep(1, length(imputed1))),
            varPropDiff3(imputed1=imputed1, imputed0=imputed0, weight=rep(1, length(imputed1))),
            varPropDiff2(imputed1=imputed1, imputed0=imputed0, weight=rep(1, length(imputed1))))
      ...
      for(qval in truncateQVal){ 
        ...
        truncateQ=cbind(truncateQ, c(mean((imputed1-imputed0)[setInt1]), varPropDiff(imputed1=imputed1[setInt1], imputed0=imputed0[setInt1], weight=rep(1, length(setInt1))),
                                     varPropDiff3(imputed1=imputed1[setInt1], imputed0=imputed0[setInt1], weight=rep(1, length(setInt1))),
                                     varPropDiff2(imputed1=imputed1[setInt1], imputed0=imputed0[setInt1], weight=rep(1, length(setInt1)))) )
      }
      ...
      for(qval in truncateVal){ 
        ...
        truncate=cbind(truncate, c(mean((imputed1-imputed0)[setInt1]), varPropDiff(imputed1=imputed1[setInt1], imputed0=imputed0[setInt1], weight=rep(1, length(setInt1))),
                                   varPropDiff3(imputed1=imputed1[setInt1], imputed0=imputed0[setInt1], weight=rep(1, length(setInt1))),
                                   varPropDiff2(imputed1=imputed1[setInt1], imputed0=imputed0[setInt1], weight=rep(1, length(setInt1)))) )
      ...
      ATM2=NULL
      ATM2=c(sum(ATMWeight_std*(imputed1-imputed0)), varPropDiff(imputed1=imputed1, imputed0=imputed0, weight=ATMWeight),
             varPropDiff3(imputed1=imputed1, imputed0=imputed0, weight=ATMWeight),
             varPropDiff2(imputed1=imputed1, imputed0=imputed0, weight=ATMWeight))
      
      
      ###restricting to matched set
      ATM=NULL
      ATM=c(mean(imputed1[inclusion] - imputed0[inclusion]), varPropDiff(imputed1=imputed1[inclusion], imputed0=imputed0[inclusion], weight=rep(1, length(inclusion))),
            varPropDiff3(imputed1=imputed1[inclusion], imputed0=imputed0[inclusion], weight=rep(1, length(inclusion))),
            varPropDiff2(imputed1=imputed1[inclusion], imputed0=imputed0[inclusion], weight=rep(1, length(inclusion))))
      ...
      ATO=c(sum(ATOWeight_std*(imputed1-imputed0)), varPropDiff(imputed1=imputed1, imputed0=imputed0, weight=ATOWeight),
            varPropDiff3(imputed1=imputed1, imputed0=imputed0, weight=ATOWeight),
            varPropDiff2(imputed1=imputed1, imputed0=imputed0, weight=ATOWeight))
      ...
      ATT=NULL
      ATT=c(mean((imputed1-imputed0)[setInt1]), varPropDiff(imputed1=imputed1[setInt1], imputed0=imputed0[setInt1], weight=rep(1, length(setInt1))),
            varPropDiff3(imputed1=imputed1[setInt1], imputed0=imputed0[setInt1], weight=rep(1, length(setInt1))),
            varPropDiff2(imputed1=imputed1[setInt1], imputed0=imputed0[setInt1], weight=rep(1, length(setInt1))))
      ...
      ATT2=NULL
      ATT2=c(sum(ATTWeight_std*(imputed1-imputed0)), varPropDiff(imputed1=imputed1, imputed0=imputed0, weight=ATTWeight),
             varPropDiff3(imputed1=imputed1, imputed0=imputed0, weight=ATTWeight),
             varPropDiff2(imputed1=imputed1, imputed0=imputed0, weight=ATTWeight))
      ...
      ATC=NULL
      ATC=c(mean((imputed1-imputed0)[setInt1]), varPropDiff(imputed1=imputed1[setInt1], imputed0=imputed0[setInt1], weight=rep(1, length(setInt1))),
            varPropDiff3(imputed1=imputed1[setInt1], imputed0=imputed0[setInt1], weight=rep(1, length(setInt1))),
            varPropDiff2(imputed1=imputed1[setInt1], imputed0=imputed0[setInt1], weight=rep(1, length(setInt1))))
      ...
      ATC2=NULL
      ATC2=c(sum(ATCWeight_std*(imputed1-imputed0)), varPropDiff(imputed1=imputed1, imputed0=imputed0, weight=ATCWeight),
             varPropDiff3(imputed1=imputed1, imputed0=imputed0, weight=ATCWeight),
             varPropDiff2(imputed1=imputed1, imputed0=imputed0, weight=ATCWeight))
      ...
      return( list(other=cbind(ATE=ATE, ATM=ATM, ATM_w=ATM2, ATO=ATO, ATT=ATT, ATT_w=ATT2,
                               ATC=ATC, ATC_w=ATC2),
                   truncate=truncate,
                   truncateQ=truncateQ ) ) ###estimate and variance of ATE
